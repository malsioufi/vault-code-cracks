...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    ...
    icon: '👑',
    rarity: 'common',
    progress: (c) => ({ current: Math.min(c.battleRoyalePlays, 1), target: 1 }),
  },
  {
    ...
    icon: '🏟️',
    rarity: 'rare',
    progress: (c) => ({ current: Math.min(c.battleRoyaleWins, 1), target: 1 }),
  },
  {
    id: 'royale_champion',
    ...
    icon: '🥇',
    rarity: 'epic',
    progress: (c) => ({ current: Math.min(c.battleRoyaleWins, 5), target: 5 }),
  },
  {
    id: 'crowd_crusher',
    name: 'Crowd Crusher',
